...
export function SubmitPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try { setCreated(await createCatalogWgsRun({project_id: projectId, platform, sequencing_batch: sequencingBatch, analysis_batch: analysisBatch, fastq_root_id: fastqRootId, use_reference: useReference})); }
