...
const metaByStatus: Record<string, StatusMeta> = {
  ...
  locked: {label: "Locked", tone: "info", Icon: CheckCircle2, active: false, terminal: true},
  available: {label: "Available", tone: "success", Icon: CheckCircle2, active: false, terminal: true},
  unavailable: {label: "Unavailable", tone: "muted", Icon: Ban, active: false, terminal: true},
  disabled: {label: "Disabled", tone: "muted", Icon: Ban, active: false, terminal: true},
  ...
  accepted: {label: "accepted", tone: "neutral", Icon: Clock3, active: true, terminal: false},
  ...
  verified: {label: "verified", tone: "success", Icon: CheckCircle2, active: false, terminal: true},
  checksum_verified: {label: "verified", tone: "success", Icon: CheckCircle2, active: false, terminal: true},
  mismatch: {label: "mismatch", tone: "danger", Icon: XCircle, active: false, terminal: true},
  checksum_failed: {label: "failed", tone: "danger", Icon: XCircle, active: false, terminal: true},
