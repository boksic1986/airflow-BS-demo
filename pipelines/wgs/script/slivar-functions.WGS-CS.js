var config = {min_GQ: 20, min_AB: 0.2, min_DP: 10}
// hi quality variants
...
function solo_ch_het_side(sample) {
  return sample.het || sample.hom_alt
}

function comphet_side(kid, mom, dad) {
  return kid.het && (solo_ch_het_side(mom) != solo_ch_het_side(dad)) && mom.alts != 2 && dad.alts != 2 && solo_ch_het_side(kid);
}
