...
- [x] Materialize a new BS10610 GATK runtime release from the clean source
...
- [x] Replace the generic `<batch>/<analysis_id>` destination for new requests
  with `<source-project-name>_GATK`.
...
- [x] Serialize observer state inside the Run Detail database session so a
