...
def submission_options(release: WgsRelease) -> dict:
    ...
    return {
        ...
        "defaults": {"algo": "DNAscope", "use_reference": "all"},
        "effective_config": {
            "prepare_sha256": "86c0a80fd91e2bd4f2fcfd4e41943a9a1ef73dd7f1239bd8677f199666333829",
            "template_sha256": "449f2b338b64cf778d503762b9d7ac0d26067a6db6c9f5777d5cc8d2405fc095",
