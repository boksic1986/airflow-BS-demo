...
deployment: .96 upgraded biodemo from 0017 to 0018 and serves the T227 frontend image on the unchanged 172.17.61.96:12959 boundary. Backend and observer use the immutable T227 release source; Airflow API/scheduler/worker were not restarted and contract v1/WGS 4.1.1 remain active.
